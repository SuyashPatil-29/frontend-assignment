...
import { unlikePost } from "@/redux/features/likeUnlikePosts";
...
const Page = () => {
  ...
  const savedPosts = localStorageAvailable && localStorage.getItem("likedPosts");
  ...
  return (
    <div>
      <h1 className="my-8 font-bold text-3xl">Liked Posts</h1>
      <Input
        type="text"
        ...
        currentPosts.map((post) => (
          <h1 className="my-3 flex gap-5 items-center" key={post.id}>
            ...
            <div className="w-full flex items-center justify-between">
              ...
              <Button onClick={() => handleAddPost(post)}>Unlike</Button>
            </div>
          </h1>
        ))
      ) : (
